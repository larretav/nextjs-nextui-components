...
export const TabsExample = () => {
  ...
  return (
    ...
    >
      <Tab
        key="all"
        title={<TitleTab title="Todos" value={100} color="primary" showZero />}
        className="[&>span]:bg-primary-500"
      />

      <Tab
        key="delivered"
        title={<TitleTab title="Enviados" value={45} color="red" />}
        className="[&>span]:bg-red-500"
      />
      
      <Tab
        key="pending"
        title={<TitleTab title="Pendientes" value={55} color="cyan" />}
